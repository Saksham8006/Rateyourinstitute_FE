...
const Error404 = () => {
  return (
    <section className="min-h-screen bg-white main overflow-y-auto  z-0 top-0  pt-[150px] pb-[100px] right-0   min-h-[calc(100vh-256px)]" >
    <div className='l-[256px] w-[800px] flex  items-center justify-center mx-auto'>
       
        <img className='w-[300px] mx-35px pb-[50px]' src="./assets/error404.png" alt="error 404 image" />
