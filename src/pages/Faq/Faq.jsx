...
const Faq = () => {
    ...
    const handleCurrentLi = (index) => {
        setCurrent(index);
        setOpen(index === current ? !open : true); // Toggle the state only if the clicked item is the current one
    };
    ...
    return (
        <>
            {/* component */}
            <div className="xll:mx-auto md:py-12 lg:px-20 md:px-6 py-9 px-4 bg-green-100/30 my-[100px]">
                <div className="max-w-[1366px] mx-auto ">
                    ...
                    <div className="flex p-6 md:flex-row flex-col md:space-x-8 md:mt-8 mt-5">
                        <div className="md:w-7/12 lg:w-full w-full md:mt-0 sm:mt-14 mt-10">
                            {/* Shipping Section */}
                            <div>
                                <div className="flex justify-between items-center cursor-pointer" onClick={() => handleCurrentLi(0)}>
                            ...
                            {/* Returns Section */}
                            <div>
                                <div className="flex justify-between items-center cursor-pointer" onClick={() => handleCurrentLi(1)}>
                                    <h3 className="text-[20px] md:text-[22px] ls:text-[24px] leading-[1.40em] md:leading-[1.455em] ls:leading-[1.333em] hover:underline text-slate-800 block relative py-[32px] pr-[70px] pl-0 font-[800] tracking-[-.018em]">
                            ...
                            <hr className="my-1 bg-[#2b784c] border-[#2b784c]" />
                            <div>
                                <div className="flex justify-between items-center cursor-pointer" onClick={() => handleCurrentLi(2)}>
                                    <h3 className="text-[20px] md:text-[22px] ls:text-[24px] leading-[1.40em] md:leading-[1.455em] ls:leading-[1.333em] hover:underline text-slate-800 block relative py-[32px] pr-[70px] pl-0 font-[800] tracking-[-.018em]">
                            ...
                            <hr className="my-1 bg-[#2b784c] border-[#2b784c]" />
                            <div>
                                <div className="flex justify-between items-center cursor-pointer" onClick={() => handleCurrentLi(3)}>
                                    <h3 className="text-[20px] md:text-[22px] ls:text-[24px] leading-[1.40em] md:leading-[1.455em] ls:leading-[1.333em] hover:underline text-slate-800 block relative py-[32px] pr-[70px] pl-0 font-[800] tracking-[-.018em]">
